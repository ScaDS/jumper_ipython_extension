...
class PerfmonitorMagicAdapter:
    ...
    def perfmonitor_help(self, line: str):
        ...
        commands = [
            ...
            "perfmonitor_load_perfdata [--file FILE] -- load performance data and push DataFrame 'perfdata_df'",
            "perfmonitor_load_cell_history [--file FILE] -- load cell history and push DataFrame 'cell_history_df'",
